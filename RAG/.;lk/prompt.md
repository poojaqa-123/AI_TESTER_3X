...
Build an end-to-end system that:
    ...
    Keeps token usage low by retrieving only the relevant context
...
GitHub Copilot + JIRA ID (MCP)
	

~30–40%

GitHub Copilot + RAG (LLM) + JIRA ID
...
Figma designs — ER diagrams, user guides, wireframes
...
5. Phase 1 — Build Now
    ...
    Build the chatbot layer, deployable to my DigitalOcean / VPS machine
...
7. Decisions I Need From You (with justification)
    ...
    What should the overall architecture, structure, and plan be?
